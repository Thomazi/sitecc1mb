...
passwordd.addEventListener('focus',()=>{
     passwordd.style.borderColor = "#516770"
})        

passwordd.addEventListener('blur',()=>{
     passwordd.style.borderColor = "#ccc"
})

var user = document.getElementById('user')

user.addEventListener('focus',()=>{
    user.style.borderColor = "#516770"
})        
...
nomee.addEventListener('focus',()=>{
    nomee.style.borderColor = "#516770"
})        

nomee.addEventListener('blur',()=>{
     nomee.style.borderColor = "#ccc"
})
